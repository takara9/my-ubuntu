...
# モジュールをインストール
RUN apt-get update && apt-get install -y python3=3.10.6-1~22.04 python3-pip=22.0.2+dfsg-1ubuntu0.4 iputils-ping=3:20211215-1 dnsutils=1:9.18.18-0ubuntu0.22.04.2 curl=7.81.0-1ubuntu1.16  iproute2=5.15.0-1ubuntu2 zip=3.0-12build2 unzip=6.0-26ubuntu3.2 groff=1.22.4-8build1
